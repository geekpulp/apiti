import {
  invariant
} from "./chunk-ZAURCAXT.js";
import "./chunk-3WRZFXJ7.js";
import {
  require_global
} from "./chunk-DXIOBCSA.js";
import "./chunk-KCICFR6K.js";
import {
  render
} from "./chunk-WHEA67IB.js";
import {
  cn,
  gt,
  yn
...
function sourceDecorator(storyFn, context) {
  ...
  if ((0, import_preview_api2.useEffect)(() => {
    ...
    source && import_preview_api2.addons.getChannel().emit(yn, { id, source, args: unmappedArgs });
